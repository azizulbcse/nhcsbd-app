                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-3 col-md-3 text-sm-end mt-3 mt-sm-0">
                                    @if(!empty($notice->file_name))
                                        <!-- ফাইলটি public/uploads/notice/ ফোল্ডারে থাকলে ডাউনলোড বা ভিউ হবে -->
                                        <a href="{{ asset('uploads/notice/' . $notice->file_name) }}" target="_blank" rel="noopener" class="btn btn-outline-primary rounded-pill px-4 py-2 transition-all w-100 fw-semibold">
