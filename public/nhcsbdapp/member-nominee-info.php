...
<head>
    <!-- Start title --> 
    <title>Member Nominee Info | Nurses Health Care Society </title>  
    <!-- End title --> 
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="photo">
				    	<form action="php_action/editApplicantNomineeImage.php" method="POST" id="updateMemberImageForm" class="form-horizontal" enctype="multipart/form-data">
				    	<br />
				    ...
				    <div role="tabpanel" class="tab-pane" id="memberInfo">
				    	<form accept-charset="utf-8" class="form-horizontal" id="editMemberForm" action="php_action/editApplicantNomineeInfo.php" method="POST">				    
				    	<br />
...
<!-- /End edit Nominee -->
    ...
    <script src="custom/js/member-nominee-info.js"></script>
