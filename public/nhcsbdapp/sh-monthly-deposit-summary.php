...
<head>
  ...
  <body class="">
            ...
            <div class="span12">
              <div class="grid simple ">
                <div class="grid-title">
                  <h3> Share Holder Monthly Deposit Summary </h3>
                </div>
                
                <div class="card">   
                <small class="float-right">      
                  <a href="printSHMonthlyDepositSummary.php" target="_blank" class="btn btn-default button1"><i class="glyphicon glyphicon-print"></i> Print Share Holder Deposit Summary  </a>
                </small>  
    ...
    <script src="custom/js/sh-monthly-deposit-summary.js"></script>
