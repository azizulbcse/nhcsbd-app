...
if($_POST) {	
	...
	$sql = "UPDATE tbltrxdepositinfo SET depositdate = '$editDepositDate',payment_type='$editPaymentType',memberid='$userid',
	deposit_from='$editDepositForm',deposit_to='$editDepositTo',deposit_amount='$editDepositAmount',trxno='$editTrxNo',remarks='$editRemarks',
	fixed_amount='$editYearlyAmount',modifier_id='$userid' WHERE trxdid= '$trxid' AND status=1"; 
