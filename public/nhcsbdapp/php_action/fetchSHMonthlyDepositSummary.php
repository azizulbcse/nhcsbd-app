...
$sql = "SELECT vmds.mid,vmds.name_english,vmds.userpic,vmds.tmpaya,vmds.tmpaida,vmds.tmduea
FROM vw_memberdepositsummary vmds, tblapplicantinfosh tai WHERE vmds.mid=tai.mid ORDER BY tai.mid ASC";
