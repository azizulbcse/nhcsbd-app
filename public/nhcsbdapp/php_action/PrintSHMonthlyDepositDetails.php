...
$orderItemSql ="SELECT trxdid,DATE_FORMAT(depositdate, '%d/%m/%Y') as depositdate,payment_type,deposit_amount,remarks
...
<body>
 ...
 <table width="800">
  ...
  <h2>Share Holder Monthly Deposit Statement </h2>
  <table width="800">
  <tr>
  <td width="270">
