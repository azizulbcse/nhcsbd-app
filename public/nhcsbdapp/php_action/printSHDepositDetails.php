...
mobileno,nid,email,bloodgroup,presentaddress,age,permanentaddress FROM tblapplicantinfosh WHERE mid = {$mid} AND status=2";
...
<body>
 ...
 <table border=1 width="800px" align="center">
        ...
        <td><b class="deposit">Sl No</b></td>
				...
				<td><b class="deposit">Monthly Amount</b></td>
        ...
        <td class="deposit"><?php echo $row['depositdate']; ?></td>
				...
				<td class="deposit"><?php echo $row['deposit_amount']; ?></td>
       ...
       $totalfixamount+=$row["fixed_amount"];
				}}
			?>

        <tr style="border-bottom: 1px solid black;">
         <td  colspan="2" style=";height: 27px;"></td>
         <td style="border-bottom: 1px solid black;;padding-center: 5px;border-center: 1px solid black"><b>Total Deposit Amount </b></td>
         <td style="border-bottom: 1px solid black;;padding-center: 5px;border-center: 1px solid black"><b><?php echo $totalamount;?> </b></td>
         <td style="border-bottom: 1px solid black;;padding-center: 5px;border-center: 1px solid black"><b><?php echo $totalfixamount;?> </b></td>
         <td style="border-bottom: 1px solid black;;padding-center: 5px;border-center: 1px solid black"><b> <?php echo$totalamount+$totalfixamount ?></b></td>
        </tr>
