...
if($_POST) {	
	...
	$sql = "UPDATE tbltrxdepositinfo SET depositdate = '$editDepositDate',memberid='$userid',deposit_from='$editDepositForm',
	deposit_to='$editDepositTo',trxno='$editTrxNo',deposit_amount='$editDepositAmount',remarks='$editRemarks',fixed_amount='$editYearlyAmount',
