...
tdi.deposit_to,tdi.deposit_amount,'Hand to Hand',tdi.remarks,tdi.status FROM tbltrxdepositinfo tdi, tblapplicantinfosh tai 
...
{ 
$sql = "SELECT tdi.trxdid,DATE_FORMAT(tdi.depositdate, '%d/%m/%Y') as depositdate,tai.userpic,tdi.payment_type,tai.name_english,
tdi.deposit_to,tdi.deposit_amount,tdi.trxno,tdi.remarks,tdi.status FROM tbltrxdepositinfo tdi, tblapplicantinfosh tai 
