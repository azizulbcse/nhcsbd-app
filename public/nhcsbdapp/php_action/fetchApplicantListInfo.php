...
tai.mobileno,tai.createdate,tai.status FROM tblapplicantinfo tai, tblhospitalname thn WHERE tai.hospitalname=thn.hid 
AND tai.status!=0 ORDER BY tai.mid asc";
