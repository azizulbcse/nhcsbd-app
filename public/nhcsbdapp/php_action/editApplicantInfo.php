...
if($_POST) {
	...
	$sql = "UPDATE tblapplicantinfo SET name_bangla='$editApplicantNameBangla',name_english='$editApplicantNameEnglish',
	...
	if($connect->query($sql) === TRUE) {
		$valid['success'] = true;
		$valid['messages'] = "Successfully Update Applicant Info";	
	} else {
		$valid['success'] = false;
		$valid['messages'] = "Error while updating Applicant info";
	}
