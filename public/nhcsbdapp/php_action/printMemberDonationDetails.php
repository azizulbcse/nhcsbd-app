...
$orderItemSql ="SELECT trxdid,DATE_FORMAT(donatedate, '%d/%m/%Y') as donatedate,payment_type,donate_amount,remarks 
FROM tbltrxdonationinfo WHERE memberid = {$mid} AND status=2";
...
<body>
 ...
 <table border=1 width="800px" align="center">
        ...
        <td class="deposit"><?php echo $row['donatedate']; ?></td>
			...
			<?php
			 $x++;
			 $totalamount+=$row["donate_amount"];
				}}
			?>

        <tr style="border-bottom: 1px solid black;">
         <td  colspan="2" style=";height: 27px;"></td>
         <td style="border-bottom: 1px solid black;;padding-center: 5px;border-center: 1px solid black"><b>Total Donate Amount </b></td>
