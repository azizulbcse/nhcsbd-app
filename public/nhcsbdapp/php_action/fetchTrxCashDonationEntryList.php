...
$sql = "SELECT tdi.trxdid,DATE_FORMAT(tdi.donatedate, '%d/%m/%Y') as donatedate,tai.userpic,tai.name_english,tdi.payment_type,
tdi.donate_from,tdi.donate_to,tdi.donate_amount,tdi.trxno,tdi.remarks,tdi.status FROM tbltrxdonationinfo tdi, tblapplicantinfo tai 
