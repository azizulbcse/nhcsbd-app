...
<head>
    <!-- Start title --> 
    <title>Loan Instalment Paid List | Nurses Health Care Society </title>  
    <!-- End title --> 
            ...
            <div class="span12">
              <div class="grid simple ">
                <div class="grid-title">
                  <h3>Loan Management / Loan Instalment Paid List </h3>
                </div>                
                <div class="card">                
                ...
                <table class="table table-bordered" id="manageTraxDepositInfoTable"> 
                  <thead>
                      ...
                      <th>Sl No</th>
			                ...
			                <th>Loan Instalment </br>Paid Date</th>
						          <th>Depositor </br> Name</th>  
                      <th>Payment </br> Type</th> 
						          <th>Payment </br> From</th> 
                      <th>Payment </br> To</th> 
                      <th>Instalment </br> No</th>  
...
<?php } ?>             
    ...
    <?php if($_GET['id']==1) { ?>
    <script src="custom/js/loan-instalmentpaid-info.js"></script>
    <?php } ?>
    <?php if($_GET['id']==2) { ?>
