  ...
  <body class="">
    ...
    <div class="page-container row">
	  ...
	  <?php 
       ...
       $sql = "SELECT * FROM tblapplicantinfosh WHERE mid = {$user_id}";
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="grid simple form-grid">
                ...
                <div class="grid-body no-border">
                  <br>
				  <form action="php_action/ChangePasswordSH.php" method="post" class="form-horizontal" id="changePasswordForm">
