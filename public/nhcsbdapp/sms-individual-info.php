...
<div class="modal fade" id="addIndividualSMSInfoModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitSMSIndividualInfoForm" action="php_action/createSMSIndividual.php" method="POST">
...
<div class="modal fade" id="editIndividualSMSModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="editIndividualSMSForm" action="php_action/editSMSIndividual.php" method="POST">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<!--End Delete Hospital info -->
    ...
    <script src="custom/js/sms-sent-individual.js"></script>
