...
<head>
    <!-- Start title --> 
    <title>Donetion Expense Entry | Nurses Health Care Society </title>  
    <!-- End title --> 
            ...
            <div class="span12">
              <div class="grid simple ">
                <div class="grid-title">
                  <h3>Donetion Info / Donetion Expense Entry Info</h3>
                </div>
...
<div class="modal fade" id="addExpenseEntryInfoModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitExpenseInfoForm" action="php_action/createTrxDoneExpenseEntryInfo.php" method="POST">
...
<div class="modal fade" id="editExpenseInfoModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="editExpenseInfoForm" action="php_action/editTrxDoneExpenseInfo.php" method="POST">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<?php } ?>                 
    ...
    <script src="custom/js/trx-donetion-expense-info.js"></script>
