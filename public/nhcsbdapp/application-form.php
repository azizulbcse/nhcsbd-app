...
<head>
    <!-- Start title --> 
      <title>Application Form | Nurses Health Care Society </title>  
    <!-- End title --> 
  ...
  <!-- BEGIN BODY -->
 <body class="" style="background-color:#00FF7F;">
        ...
        <div class="col-md-7 col-md-offset-2 tiles white no-padding" align="center">
          ...
          <a href="index.php" class="app-brand-link gap-2">
            ...
            <div role="tabpanel" class="tab-pane active" id="tab_login" align="center">
              <form action="php_action/createApplicationForm.php" method="post" class="form-horizontal" id="ApplicationForm">              
