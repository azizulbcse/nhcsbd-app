...
<div class="col-md-12 mt-4">
        ...
        <div class="d-flex align-items-start">
            ...
            <div class="w-100">
                ...
                <p class="text-secondary mb-3">
                    আপনি কি লোনের জন্য আগ্রহী? আমাদের সহজ অনলাইন প্রক্রিয়ায় আপনি লোনের আবেদন করতে পারবেন। 
                    আবেদন করতে বাম পাশের মেনু থেকে <strong>"Application Info"</strong> সেকশনে যান।
                </p>
                
                <div class="d-flex justify-content-between align-items-center">
                    <span class="warning-text text-danger">
                        <i class="fas fa-exclamation-triangle me-1"></i> 
                        আবেদন করার আগে অবশ্যই প্রোফাইল, নমিনি এবং ব্যাংকের প্রয়োজনীয় তথ্য আপডেট করুন।
                    </span>
                    <button class="btn btn-outline-info btn-sm rounded-pill px-3">কিভাবে করবেন?</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <?php
    // --- প্রোফাইল চেকিং লজিক শুরু ---
$userIdForCheck = $_SESSION['userId'];
$profileQuery = $connect->query("SELECT bankmname, branchname, acc_no, acc_name, mobilebanktype, mobilebankno, userpic, nid, nomineename FROM tblapplicantinfo WHERE mid = $userIdForCheck");
$profileData = $profileQuery->fetch_assoc();

$required_fields = [
    'bankmname'      => 'ব্যাংকের নাম',
    'branchname'     => 'ব্রাঞ্চের নাম',
    'acc_no'         => 'একাউন্ট নম্বর',
    'acc_name'       => 'একাউন্ট হোল্ডারের নাম',
    'mobilebanktype' => 'মোবাইল ব্যাংকিং টাইপ',
    'mobilebankno'   => 'মোবাইল ব্যাংকিং নম্বর',
    'userpic'        => 'নিজের ছবি',
    'nid'            => 'NID নম্বর',
...
$missing_data = [];
if ($profileData) {
    foreach ($required_fields as $column => $label) {
        if (empty($profileData[$column]) || trim($profileData[$column]) == "") {
            $missing_data[] = $label;
        }
    }
}
$is_profile_complete = empty($missing_data);
// --- প্রোফাইল চেকিং লজিক শেষ ---
    ?>
    <div class="col-md-12 mt-4">
    <?php if ($is_profile_complete): ?>
        <div class="custom-loan-alert border shadow-sm" style="border-left: 5px solid #28a745;">
            <div class="d-flex align-items-start">
                <div class="alert-icon text-success">
                    <i class="fas fa-check-circle animated bounceIn"></i>
                </div>
                <div class="w-100">
                    <h4 class="notice-title text-success">সম্মানিত সদস্য!</h4>
                    <p class="text-secondary mb-3">
                        আপনার প্রোফাইল, ব্যাংক এবং নমিনি তথ্য সম্পূর্ণ আছে। 
                    </p>
                </div>
            </div>
        </div>
    <?php else: ?>
        <div class="custom-loan-alert border shadow-sm" style="border-left: 5px solid #dc3545;">
            <div class="d-flex align-items-start">
                <div class="alert-icon text-danger">
                    <i class="fas fa-exclamation-triangle animated swing infinite"></i>
                </div>
                <div class="w-100">
                    <h4 class="notice-title text-danger">তথ্য অসম্পূর্ণ!</h4>
                    <p class="text-secondary mb-2">
                        লোন আবেদন করার জন্য আপনার প্রোফাইলের কিছু তথ্য এখনো বাকি আছে। অনুগ্রহ করে নিচের তথ্যগুলো আপডেট করুন:
                    </p>
                    <div class="mb-3">
                        <span class="warning-text text-danger" style="background: #fff0f0;">
                            <strong>বাকি আছে:</strong> <?php echo implode(', ', $missing_data); ?>
                        </span>
                    </div>
                    <a href="#" class="btn btn-danger btn-sm rounded-pill px-4 shadow-sm">
                        <i class="fas fa-user-edit me-1"></i> প্রোফাইল,নমিনির তথ্য এবং ব্যাংকের তথ্যগুলো আপডেট করুন
                    </a>
                </div>
            </div>
        </div>
          ...
          <div class="row">            
                ...
                <div class="tiles-body">
                  ...
                  <div class="widget-stats">
                    <div class="wrapper transparent">
                      <span class="item-title"> জমা দিতে হবে </span> <span class="item-count animate-number semi-bold" data-value="<?php echo $totalpayable; ?>" data-animation-duration="700">0</span>
                    </div> 
                  </div>
                  <div class="widget-stats">
                    <div class="wrapper transparent">
                      <span class="item-title"> জমা দিছি </span> <span class="item-count animate-number semi-bold" data-value="<?php echo $totalpaid; ?>" data-animation-duration="700">0</span>
                    </div>
                  </div>
                  <div class="widget-stats ">
                    <div class="wrapper last">
                      <span class="item-title"> বকেয়া আছে </span> <span class="item-count animate-number semi-bold" data-value="<?php echo $totaldue; ?>" data-animation-duration="700">0</span>
                    </div>
                  </div>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="tiles blue m-b-10">
                <div class="tiles-body">
                  ...
                  <div class="widget-stats">
                    <div class="wrapper transparent">
                      <span class="item-title"> জমা দিতে হবে </span> <span class="item-count animate-number semi-bold" data-value="<?php echo $totalfixedapayable; ?>" data-animation-duration="700">0</span>
                    </div>
                  </div>
                  <div class="widget-stats">
                    <div class="wrapper transparent">
                      <span class="item-title"> জমা দিছি </span> <span class="item-count animate-number semi-bold" data-value="<?php echo $totalfixedapaid; ?>" data-animation-duration="700">0</span>
                    </div>
                  </div>
                  <div class="widget-stats ">
                    <div class="wrapper last">
                      <span class="item-title"> বকেয়া আছে </span> <span class="item-count animate-number semi-bold" data-value="<?php echo $totalfixedadue; ?>" data-animation-duration="700">0</span>
                    </div>
                  </div>
                  <div class="progress transparent progress-small no-radius m-t-20" style="width:100%">                    
                  </div>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="tiles red m-b-10">
                <div class="tiles-body">
                  ...
                  <div class="widget-stats">
                    <div class="wrapper transparent">
                      <span class="item-title"> জমা দিতে হবে </span> <span class="item-count animate-number semi-bold" data-value="<?php echo $membertotalpayable; ?>" data-animation-duration="700">0</span>
                    </div>
                  </div>
                  <div class="widget-stats">
                    <div class="wrapper transparent">
                      <span class="item-title"> জমা দিছি </span> <span class="item-count animate-number semi-bold" data-value="<?php echo $membertotalpaid; ?>" data-animation-duration="700">0</span>
                    </div>
                  </div>
                  <div class="widget-stats ">
                    <div class="wrapper last">
                      <span class="item-title"> বকেয়া আছে </span> <span class="item-count animate-number semi-bold" data-value="<?php echo $membertotaldue; ?>" data-animation-duration="700">0</span>
                    </div>
                  </div>
                  <div class="progress transparent progress-small no-radius m-t-20" style="width:100%">                    
                  </div>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="tiles purple m-b-10">
                <div class="tiles-body">
                  <div class="tiles-title text-black"> আমার জমার পরিমান </div>
                  <div class="widget-stats">
                    <div class="wrapper transparent">
                      <span class="item-title"> সকল জমা </span> <span class="item-count animate-number semi-bold" data-value="<?php echo $membertotalpaid; ?>" data- animation-duration="100">0</span>
                    </div>
                  </div>
                  <div class="widget-stats">
                    <div class="wrapper transparent">
