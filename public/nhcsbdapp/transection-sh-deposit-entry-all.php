...
<div class="modal fade" id="editDepositEntryInfoModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
	    <?php if($_GET['id']==1) { ?>
    	<form class="form-horizontal" id="editDepositEntryInfoForm" action="php_action/editDepositSHCashEntryAll.php" method="POST">
		<?php } ?>
		<?php if($_GET['id']==2) { ?>
    	<form class="form-horizontal" id="editDepositEntryInfoForm" action="php_action/editDepositSHOnlineCashEntryAll.php" method="POST">
		<?php } ?>
		<?php if($_GET['id']==3) { ?>
    	<form class="form-horizontal" id="editDepositEntryInfoForm" action="php_action/editDepositSHMBEntryAll.php" method="POST">
		<?php } ?>
	      ...
	      <div class="modal-body">
			...
			<div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="number" class="form-control" id="editDepositAmount" placeholder="টাকার পরিমাণ" name="editDepositAmount" readonly="false">
				    </div>
	        </div>
			...
			<div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <select class="form-control selectpicker" data-live-search="true" id="editRemarks" name="editRemarks">
...
<!--End edit Deposit info -->                  
	...
	<?php if($_GET['id']==1) { ?>
		<script src="custom/js/transection-sh-deposit-cash-all.js"></script>
    <?php } ?>
	<?php if($_GET['id']==2) { ?>
		<script src="custom/js/transection-sh-deposit-onlinecash-all.js"></script>
    <?php } ?>
	<?php if($_GET['id']==3) { ?>
		<script src="custom/js/transection-sh-deposit-mb-all.js"></script>
    <?php } ?>
