...
<head>
    <!-- Start title --> 
    <title>Loan EMI Entry | Nurses Health Care Society </title>  
    <!-- End title --> 
            ...
            <div class="span12">
              <div class="grid simple ">
                <div class="grid-title">
                  <h3>Loan Management / Self Loan EMI Paid List </h3>
                </div>
                
                <div class="card">
                <small class="float-right">      
                  <button class="btn btn-default button1" data-toggle="modal" data-target="#addDepositEntryInfoModel"> <i class="glyphicon glyphicon-plus-sign"></i> Self Loan EMI Entry </button>
                </small>
...
<div class="modal fade" id="addDepositEntryInfoModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
	    <?php if($_GET['id']==1) { ?>
    	<form class="form-horizontal" id="submitDepositInfoForm" action="php_action/createLoanEmiCashEntryInfo.php" method="POST">
		<?php } ?>
		<?php if($_GET['id']==2) { ?>
    	<form class="form-horizontal" id="submitDepositInfoForm" action="php_action/createLoanEMIOnlineEntryInfo.php" method="POST">
		<?php } ?>
		<?php if($_GET['id']==3) { ?>
    	<form class="form-horizontal" id="submitDepositInfoForm" action="php_action/createLoanEMIMBEntryInfo.php" method="POST">
		<?php } ?>
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title"><i class="fa fa-plus"></i> Loan EMI Info </h4>
	      </div>
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<label for="DepositDate" class="col-sm-2 control-label"> Loan Paid Date </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="date" class="form-control" id="DepositDate" placeholder="Loan Paid Date" name="DepositDate" autocomplete="off">
				    </div>
	        </div>	
			
			<div class="form-group">
	        	<label for="InstalmentNo" class="col-sm-2 control-label"> Instalment No </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
                       <select class="form-control selectpicker" data-live-search="true" id="InstalmentNo" name="InstalmentNo" onChange="getCustomerData1(this)">
				      	<option value="">~~PLEASE SELECT~~</option>
				      	    <?php 								
                                $sql = "SELECT schedule_id,CONCAT(installment_no,'/',emi_amount,'/',due_date) as installment_no FROM tblloanschedule where payment_status='Unpaid' AND member_id={$user_id} Order by installment_no+0 ASC" ;
			...
			<div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="number" step="0.01" class="form-control" id="DepositAmount" value="0.00" placeholder="টাকার পরিমাণ" name="DepositAmount">
					  <input type="hidden" step="0.01" class="form-control" id="DepositAmountValue" name="DepositAmountValue" />
				    </div>
	        </div>
...
<div class="modal fade" id="editDepositEntryInfoModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
	    <?php if($_GET['id']==1) { ?>
    	<form class="form-horizontal" id="editDepositEntryInfoForm" action="php_action/editLoanEMICashEntryInfo.php" method="POST">
		<?php } ?>
		<?php if($_GET['id']==2) { ?>
    	<form class="form-horizontal" id="editDepositEntryInfoForm" action="php_action/editLoanEMIOnlineCashEntryInfo.php" method="POST">
		<?php } ?>
		<?php if($_GET['id']==3) { ?>
    	<form class="form-horizontal" id="editDepositEntryInfoForm" action="php_action/editLoanEMIMBEntryInfo.php" method="POST">
		<?php } ?>
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	      ...
	      <div class="modal-body">
			...
			<div class="form-group">
	        	<label for="editInstalmentNo" class="col-sm-2 control-label"> Instalment No </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
                       <select class="form-control" id="editInstalmentNo" name="editInstalmentNo" onChange="getCustomerData1(this)">
				      	<option value="">~~PLEASE SELECT~~</option>
				      	    <?php 								
                                $sql = "SELECT schedule_id,CONCAT(installment_no,'/',emi_amount,'/',due_date) as installment_no FROM tblloanschedule where payment_status='Unpaid' AND member_id={$user_id} Order by installment_no+0 ASC" ;
								$result = $connect->query($sql);
			...
			<div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="number" step="0.01" class="form-control" id="editDepositAmount" value="0.00" placeholder="টাকার পরিমাণ" name="editDepositAmount">
					  <input type="hidden" step="0.01" class="form-control" id="DepositAmountValue" name="DepositAmountValue" />
				    </div>
	        </div></div>
...
<!--End edit Deposit info -->                  
	...
	<?php if($_GET['id']==1) { ?>
		<script src="custom/js/transection-loanemi-cash-entry-info.js"></script>
    <?php } ?>
	<?php if($_GET['id']==2) { ?>
		<script src="custom/js/transection-loanemi-onlinecash-entry-info.js"></script>
    <?php } ?>
	<?php if($_GET['id']==3) { ?>
		<script src="custom/js/transection-loanemi-mb-entry-info.js"></script>
    <?php } ?>
