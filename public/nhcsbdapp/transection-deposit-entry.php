		...
		<?php } ?>
	      ...
	      <div class="modal-body">
			...
			<div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="number" class="form-control" value="2000.00" id="editDepositAmount" placeholder="টাকার পরিমাণ" name="editDepositAmount" readonly="false">
				    </div>
	        </div>
...
<!--End edit Deposit info -->                  
	...
	<?php if($_GET['id']==1) { ?>
		<script src="custom/js/transection-deposit-cash-entry-info.js"></script>
    <?php } ?>
	<?php if($_GET['id']==2) { ?>
		<script src="custom/js/transection-deposit-onlinecash-entry-info.js"></script>
    <?php } ?>
	<?php if($_GET['id']==3) { ?>
		<script src="custom/js/transection-deposit-mb-entry-info.js"></script>
    <?php } ?>
