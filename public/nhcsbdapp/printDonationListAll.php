...
$orderItemSql ="SELECT tdi.trxdid,DATE_FORMAT(tdi.donatedate, '%d/%m/%Y') as donatedate,tdi.depositername,tdi.payment_type,tdi.donate_amount,tdi.remarks FROM tbltrxdonationinfo tdi, tbldonatelist tdl 
