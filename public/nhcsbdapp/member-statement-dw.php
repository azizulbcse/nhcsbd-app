                    ...
                    <div class="span10 offset1"> <!-- Center aligned -->
                        <div class="grid simple report-card">
                            <div class="grid-title">
                                <h3><i class="fa fa-file-text-o"></i>Member Deposit <span class="semi-bold">Statement </span></h3>
                            </div>
                            
                            <div class="report-form-container bg-white">
                                <form action="php_action/member-statement-dw.php" method="post" id="getDepositReportForm">
                                    <div class="row">
                        <div class="col-md-6">
                        <div class="row form-row">
                          <div class="col-md-12">
						    <label for="memberID" class="form-label">Member Name </label>
                            <select type="text" class="form-control selectpicker" data-live-search="true" id="memberID" name="memberID" required="">
				      	        <option value="">~~Please Select Member Name~~</option>
				      	            <?php 
				      	                $sql = "SELECT mid, CONCAT(name_english, '/',mobileno,'/',permanentaddress) as name_english FROM tblapplicantinfo where status=2 Order by name_english ASC";
