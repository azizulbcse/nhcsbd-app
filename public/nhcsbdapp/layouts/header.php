<head>
    ...
    <meta http-equiv="content-type" content="text/html;charset=UTF-8" />
    <meta name="google-site-verification" content="SYoq0lrGAbr99JtoGHmjBVRaaQupnNA0PfSTUV94rOQ" />
    ...
    <link rel="icon" href="assets/img/logo-fe.jpg" type="image/gif" sizes="20x20">
...
<body class="tt-magic-cursor home-5">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="login-wrapper">
                        <div class="login-img">
                            <img src="assets/img/home1/login-img.png" alt="Nurses Health Care Society">
                            <div class="logo">
								<a href="index.php"><img src="assets/img/logo-fe.jpg" alt="Nurses Health Care Society"></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="top-bar style-5">
        <div class="logo-and-menu">
            ...
            <div class="menu">
                <ul>
				    <h2><li>Nurses Health Care Society Bangladesh</li></h2>
					<li><a href="1admin-login.php">Admin Login</a></li>
					<li><a href="2member-login.php">Member Login</a></li>
                    <!--<li><a href="3share-holder-login.php">Share Holder </br> Login</a></li>-->
                </ul>
            </div>
        </div>
                ...
                <li>
                    <div class="hotline-area d-xl-flex d-none">
                        ...
                        <div class="content">
                            ...
                            <h6><a href="tel:+01717288965">01717288965</a></h6>
							<h6><a href="tel:+01689597474">01689597474</a></h6>
                        </div>
                    </div>
                </li>
            </ul>
    ...
    <header class="header-area style-5">
        <div class="header-logo d-lg-none d-flex">
			<a href="index.php"><img alt="image" class="img-fluid" src="assets/img/logo-fe.jpg"></a>
        </div>
        <div class="main-menu">
            <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                <div class="mobile-logo-wrap">
					<a href="index.php"><img alt="image" src="assets/img/logo-fe.jpg"></a>
                </div>
            </div>
<ul class="menu-list">
    <!--<li> <a href="index.php" class="drop-down"><i class="fa fa-home"></i> Home</a> </li>-->
    <li> <a href="constitution.php" class="drop-down"><i class="fa fa-book"></i> Constitution (গঠনতন্ত্র)</a> </li>				
    <li> <a href="admin-list.php" class="drop-down"><i class="fa fa-user-shield"></i> Administrator List</a> </li>
    <li> <a href="member-list.php" class="drop-down"><i class="fa fa-users"></i> Member List</a> </li>                
    <li> <a href="application4join.php" class="drop-down"><i class="fa fa-user-plus"></i> Application for Join</a> </li>
    <li> <a href="contact-payment.php" class="drop-down"><i class="fa fa-money-check-alt"></i> Deposit Details</a> </li>
    <li> <a href="emi-calculator.php" class="drop-down"><i class="fa fa-calculator"></i> EMI Calculator</a> </li>
    <li> <a href="notice.php" class="drop-down"><i class="fa fa-bell"></i> Notice</a> </li>
</ul>

                <!--<li> <a href="terms&condition.php" class="drop-down">Terms & Condition</a> </li>-->
                <!--<li> <a href="donation-entry-form.php" class="drop-down">Donate Here</a> </li>-->
                <!--<li> <a href="#" class="drop-down">Gallery</a> </li>-->
            <!--<li> <a href="vision.php" class="drop-down">Visions & Missions</a> </li>-->
            <!--<li> <a href="share-holder-list.php" class="drop-down">Share Holder List</a> </li>-->
            <div class="topbar-right d-lg-none d-block">
			    <a href="1admin-login.php" class="drop-down">Admin Login</a>
			    <a href="2member-login.php" class="drop-down">Member Login</a>
                <!--<a href="3share-holder-login.php">SHARE HOLDER LOGIN</a>-->
            </div>
