...
<head>
    <!-- Start title --> 
    <title>Member Donation Summary | Nurses Health Care Society </title>  
    <!-- End title --> 
  ...
  <body class="">
            ...
            <div class="span12">
              <div class="grid simple ">
                <div class="grid-title">
                  <h3>Member Info / Member Donation Summary </h3>
                </div>
                
                <div class="card">   
                <small class="float-right">      
                  <a href="printMemberDonationSummary.php" target="_blank" class="btn btn-default button1"><i class="glyphicon glyphicon-print"></i> Print Member Donation Summary  </a>
                </small>             
    ...
    <script src="custom/js/member-donation-summary.js"></script>
