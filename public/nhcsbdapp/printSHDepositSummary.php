...
$orderItemSql ="SELECT mid,name_english,userpic,mobileno,tmpaya,tmpaida,tmduea,tpayfixeda,tpaidfixeda,tfixeduea,tpaya,tpaida,tduea
...
<body>
 ...
 <table width="800">
  ...
  <h2> Share Holder Deposit Summary </h2>
 </div>
 ...
 <table border=1 width="800px" align="center">
        ...
        <td><b class="deposit">Fixed Payable Amount </td>
        <td><b class="deposit">Fixed Paid Amount</td>
        <td><b class="deposit">Fixed Due Amount</td>
        <td><b class="deposit">Total Payable Amount </td>
        <td><b class="deposit">Total Paid Amount</td>
        <td><b class="deposit">Total Due Amount</td>
			</tr>
         <?php
			   $x = 1;
        ...
        <td class="deposit"><?php echo $row['tpaya']; ?></td>
				<td class="deposit"><?php echo $row['tpaida']; ?></td>		
        <td class="deposit"><?php echo $row['tduea']; ?></td>
			</tr>
			<?php
			 $x++;
			 $tmpaya+=$row["tmpaya"];
       ...
       $tduea+=$row["tduea"];
        ...
        <tr style="border-bottom: 1px solid black;">
         ...
         <td style="border-bottom: 1px solid black;;padding-center: 5px;border-center: 1px solid black"><b><?php echo $tpaya;?> </b></td>
         <td style="border-bottom: 1px solid black;;padding-center: 5px;border-center: 1px solid black"><b><?php echo $tpaida;?> </b></td>
         <td style="border-bottom: 1px solid black;;padding-center: 5px;border-center: 1px solid black"><b><?php echo $tduea;?> </b></td>
        </tr>
