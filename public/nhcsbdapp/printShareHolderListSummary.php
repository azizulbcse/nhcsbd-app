...
<?php
$orderItemSql ="SELECT ai.mid,ai.name_english,ai.userpic,hn.hospitalname,ai.mobileno,ai.email,bloodgroup,ai.presentaddress
FROM tblapplicantinfosh ai, tblhospitalname hn WHERE ai.status=2 AND ai.hospitalname=hn.hid";
...
<body>
 ...
 <table border=1 width="800px" align="center">
        ...
        <td><b class="deposit">Job Location</b></td>
				<td><b class="deposit">Mobile No</b></td>
				<td><b class="deposit">Email</b></td>
        <td><b class="deposit">Blood Group</b></td>
        <td><b class="deposit">Present Address</b></td>
			</tr>
         <?php
			   $x = 1;
        ...
        <td class="deposit"><?php echo $row['hospitalname']; ?></td>
				<td class="deposit"><?php echo $row['mobileno']; ?></td>
				<td class="deposit"><?php echo $row['email']; ?></td>						
        <td class="deposit"><?php echo $row['bloodgroup']; ?></td>
        <td class="deposit"><?php echo $row['presentaddress']; ?></td>
			</tr>
			<?php
			 $x++;
				}
