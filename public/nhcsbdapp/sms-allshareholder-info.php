...
<head>
    <!-- Start title --> 
    <title>All Share Holder SMS | Nurses Health Care Society </title>  
    <!-- End title --> 
            ...
            <div class="span12">
              <div class="grid simple ">
                <div class="grid-title">
                  <h3>SMS Info / All Share Holder SMS Send </h3>
                </div>
...
<div class="modal fade" id="addIndividualSMSInfoModel" tabindex="-1" role="dialog"> 
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitSMSIndividualInfoForm" action="php_action/createSMSAllSH.php" method="POST">
...
<div class="modal fade" id="editIndividualSMSModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="editIndividualSMSForm" action="php_action/editSMSAllSH.php" method="POST">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title"><i class="fa fa-edit"></i> Edit SMS Info </h4>
	      </div>
	      <div class="modal-body">
...
<!--End Delete Hospital info -->
    ...
    <script src="custom/js/sms-sent-allshareholder.js"></script>
