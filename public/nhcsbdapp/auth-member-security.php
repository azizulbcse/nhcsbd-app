  ...
  <body class="">
    ...
    <div class="page-container row">
	  ...
	  <?php 
       ...
       $sql = "SELECT * FROM tblapplicantinfo WHERE mid = {$user_id}";
          ...
          <div class="row">
				  ...
				  <div class="changeUsenrameMessages"></div>
                    <div class="form-group">
                      <label class="form-label">Username</label>
					              <input type="text" class="form-control" id="username" name="username" readonly="false" placeholder="Usename" value="<?php echo $result['email']; ?>"/>
                    </div>                    

                    <div class="form-actions">
                      <div class="pull-right">
						<input type="hidden" name="user_id" id="user_id" value="<?php echo $result['mid'] ?>" /> 
            ...
            <div class="col-md-6">
              <div class="grid simple form-grid">
                ...
                <div class="grid-body no-border">
                  <br>
				  <form action="php_action/ChangePasswordMember.php" method="post" class="form-horizontal" id="changePasswordForm">
