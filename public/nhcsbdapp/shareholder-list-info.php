...
<head>
    <!-- Start title --> 
    <title>Share Holder List | Nurses Health Care Society </title>  
    <!-- End title --> 
            ...
            <div class="span12">
              <div class="grid simple ">
                <div class="grid-title">
                  <h3>Share Holder List Info</h3>
                </div>
                
                <div class="card">
                <small class="float-right">      
                  <a href="printShareHolderListSummary.php" target="_blank" class="btn btn-default button1"><i class="glyphicon glyphicon-print"></i> Print Share Holder Summary  </a>
                </small> 
...
<!--End Delete Applicant info -->
    ...
    <script src="custom/js/shareholder-list.js"></script>
