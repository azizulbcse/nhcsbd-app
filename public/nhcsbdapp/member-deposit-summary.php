...
<head>
  ...
  <body class="">
            ...
            <div class="span12">
              <div class="grid simple ">
                <div class="grid-title">
                  <h3> Member Total Deposit Summary </h3>
                </div>
                
                <div class="card">   
                <small class="float-right">      
                  <a href="printMemberDepositSummary.php" target="_blank" class="btn btn-default button1"><i class="glyphicon glyphicon-print"></i> Print Member Deposit Summary  </a>
                </small>  
    ...
    <script src="custom/js/member-deposit-summary.js"></script>
