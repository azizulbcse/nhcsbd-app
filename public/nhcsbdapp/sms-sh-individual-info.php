...
<head>
    <!-- Start title --> 
    <title>Individual SMS | Nurses Health Care Society </title>  
    <!-- End title --> 
            ...
            <div class="span12">
              <div class="grid simple ">
                <div class="grid-title">
                  <h3>SMS Info / Individual SMS Send </h3>
                </div>
...
<div class="modal fade" id="addIndividualSMSInfoModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitSMSIndividualInfoForm" action="php_action/createSMSIndividualSH.php" method="POST">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title"><i class="fa fa-plus"></i> Add Individual SMS Info </h4>
	      </div>
          ...
          <div class="form-group">
              ...
              <select class="form-control selectpicker"  data-live-search="true" id="MemberName" name="MemberName">
				      	...
				      	<?php 
                $sql = "SELECT mid,CONCAT(name_english, '/',mobileno) as customername FROM tblapplicantinfosh where status=2 Order by mid ASC" ;
...
<div class="modal fade" id="editIndividualSMSModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="editIndividualSMSForm" action="php_action/editSMSIndividualSH.php" method="POST">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          ...
          <div class="form-group">
	        	<label for="editMemberName" class="col-sm-3 control-label"> Member Name </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
...
<!--End Delete Hospital info -->
    ...
    <script src="custom/js/sms-sent-individual-sh.js"></script>
