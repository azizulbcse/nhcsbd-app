...
<head>
    <!-- Start title --> 
    <title>Share Holder Deposit Summary | Nurses Health Care Society </title>  
    <!-- End title --> 
  ...
  <body class="">
            ...
            <div class="span12">
              <div class="grid simple ">
                <div class="grid-title">
                  <h3>Share Holder Deposit Summary </h3>
                </div>
                
                <div class="card">   
                <small class="float-right">      
                  <a href="printSHDepositSummary.php" target="_blank" class="btn btn-default button1"><i class="glyphicon glyphicon-print"></i> Print Share Holder Deposit Summary  </a>
                </small>  
    ...
    <script src="custom/js/sh-deposit-summary.js"></script>
