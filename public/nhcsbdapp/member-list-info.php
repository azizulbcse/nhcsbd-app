...
<head>
    <!-- Start title --> 
    <title>Applicant List | Nurses Health Care Society </title>  
    <!-- End title --> 
            ...
            <div class="span12">
              <div class="grid simple ">
                <div class="grid-title">
                  <h3>Member List Info</h3>
                </div>
                
                <div class="card">
                <small class="float-right">      
                  <a href="printMemberListSummary.php" target="_blank" class="btn btn-default button1"><i class="glyphicon glyphicon-print"></i> Print Member Summary  </a>
                </small>  
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	      ...
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title"><i class="fa fa-edit"></i> Edit Applicant Info</h4>
	      </div>
	      <div class="modal-body" style="max-height:850px; overflow:auto;">
	      	...
	      	<div class="div-result">
				  ...
				  <ul class="nav nav-tabs" role="tablist">
				    <li role="presentation" class="active"><a href="#photo" aria-controls="home" role="tab" data-toggle="tab">Applicant Photo</a></li>
				    <li role="presentation"><a href="#memberInfo" aria-controls="profile" role="tab" data-toggle="tab">Applicant Info </a></li>    
				  </ul>
				  ...
				  <div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="photo">
				    	<form action="php_action/editApplicantImage.php" method="POST" id="updateMemberImageForm" class="form-horizontal" enctype="multipart/form-data">
				    	<br />
				    	<div id="edit-memberPhoto-messages"></div>

				    	<div class="form-group">
			        	<label for="editUserImage" class="col-sm-3 control-label">Applicant Photo </label>
			      	...
			      	<div class="form-group">
			        	<label for="editUserImage" class="col-sm-3 control-label">Select Applicant Photo </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
							    <!-- the avatar markup -->
				    ...
				    <div role="tabpanel" class="tab-pane" id="memberInfo">
				    	<form accept-charset="utf-8" class="form-horizontal" id="editMemberForm" action="php_action/editApplicantInfo.php" method="POST">				    
				    	<br />
...
<!--End Delete Applicant info -->
    ...
    <script src="custom/js/application-form-list.js"></script>
