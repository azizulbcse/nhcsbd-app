                ...
                <div class="col-xl-12">
                    <div class="row mb-40">
                        <div class="col-lg-12">
                            <div class="show-item-and-filte">
                                <p>Showing <strong>Investment Committee List</strong></p>
                    ...
                    <div class="list-grid-main">
                        <div class="list-grid-product-wrap grid-group-wrapper">
							...
							<?php
	                            $sql = "SELECT tai.mid,tai.name_english,tai.userpic,tai.mobileno,th.hospitalname FROM tblapplicantinfo tai, tblhospitalname th WHERE tai.hospitalname=th.hid AND tai.status=2 AND tai.mid in('9','4','6','21','47','51','52')";
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="200ms">
                                    <div class="product-card4">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <div class="location">
                                                <a href="#"><i class="bi bi-mobile-alt"></i>  <?php echo $row['mobileno'] ?> </a>
                                            </div>
