...
<head>
    <!-- Start title --> 
    <title>Resignation Reasons List Info | Nurses Health Care Society </title>  
    <!-- End title --> 
            ...
            <div class="span12">
              <div class="grid simple ">
                <div class="grid-title">
                  <h3>Setup / Resignation Reasons List Info</h3>
                </div>
                
                <div class="card">
                <small class="float-right">      
                  <button class="btn btn-default button1" data-toggle="modal" data-target="#addBankInfoModel"> <i class="glyphicon glyphicon-plus-sign"></i> Add Resignation Reasons </button>
                </small>
...
<div class="modal fade" id="addBankInfoModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitBankInfoForm" action="php_action/createSetupResignResonsInfo.php" method="POST">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title"><i class="fa fa-plus"></i> Add Resignation Reasons Info</h4>
	      </div>
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<label for="bankName" class="col-sm-3 control-label"> Resign Reasons </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="bankName" placeholder="Resign Reasons " name="bankName" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	         	        
...
<div class="modal fade" id="editBankInfoModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="editBankInfoForm" action="php_action/editSetupResignReasonsInfo.php" method="POST">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	      ...
	      <div class="modal-body">
		      ...
		      <div class="edit-bankinfo-result">
		      	<div class="form-group">
		        	<label for="editbankName" class="col-sm-3 control-label"> Resign Reasons </label>
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-8">
					      <input type="text" class="form-control" id="editbankName" placeholder="Resign Reasons" name="editbankName" autocomplete="off">
					    </div>
		        </div> <!-- /form-group-->	         	        
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeBankInfoModel">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> Remove Resign Reasons </h4>
      </div>
      <div class="modal-body">
...
<!--End Delete Bank info -->
    ...
    <script src="custom/js/setup-resign-reasons-info.js"></script>
