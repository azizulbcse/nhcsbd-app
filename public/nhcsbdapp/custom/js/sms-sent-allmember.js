...
$(document).ready(function() {
	...
	manageSMSIndividualInfoTable = $("#manageSMSIndividualInfoTable").DataTable({
		'ajax': 'php_action/fetchSMSAllMember.php',
		'order': []		
	});
...
function editIndividualSMSInfo(smsid = null) {
	...
	{ 
		...
		$.ajax({
			url: 'php_action/fetchSelectedSMSAllMember.php',
			type: 'post',
			data: {smsid : smsid},
			dataType: 'json',
			success:function(response) {
			...
			success:function(response) {
				...
				$("#postingSMSIndividualBtn").unbind('click').bind('click', function() {
					...
					$.ajax({
						...
						url: 'php_action/postSMSAllMember.php',                         
						type: 'post',
						data: {smsid : smsid},
						dataType: 'json',
						success:function(response) {
						...
						$.ajax({
						url: 'php_action/send-sms-allmember.php',	
						type: 'post',
						data: {smsid : smsid},
						dataType: 'json',
						success:function(response) {
		...
		$.ajax({
			...
			success:function(response) {
				...
				$("#removeSMSIndividualBtn").unbind('click').bind('click', function() {
					...
					$.ajax({
						url: 'php_action/removeSMSAllMember.php',
						type: 'post',
						data: {smsid : smsid},
						dataType: 'json',
						success:function(response) {
