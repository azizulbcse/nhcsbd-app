...
$(document).ready(function() {
	...
	manageSMSIndividualInfoTable = $("#manageSMSIndividualInfoTable").DataTable({
		'ajax': 'php_action/fetchSMSSentIndividualSH.php',
		'order': []		
	});
...
function editIndividualSMSInfo(smsid = null) {
	...
	{ 
		...
		$.ajax({
			url: 'php_action/fetchSelectedSMSIndividualSH.php',
			type: 'post',
			data: {smsid : smsid},
			dataType: 'json',
			success:function(response) {
			...
			success:function(response) {
				...
				$("#postingSMSIndividualBtn").unbind('click').bind('click', function() {
					...
					$.ajax({
						...
						url: 'php_action/postSMSIndividualSH.php',                         
						type: 'post',
						data: {smsid : smsid},
						dataType: 'json',
						success:function(response) {
						...
						$.ajax({
						url: 'php_action/send-sms-individualSH.php',	
						type: 'post',
						data: {smsid : smsid},
						dataType: 'json',
						success:function(response) {
		...
		$.ajax({
			...
			success:function(response) {
				...
				$("#removeSMSIndividualBtn").unbind('click').bind('click', function() {
					...
					$.ajax({
						url: 'php_action/removeSMSIndividualSH.php',
						type: 'post',
						data: {smsid : smsid},
						dataType: 'json',
						success:function(response) {
