...
$(document).ready(function() {
	...
	manageSMSIndividualInfoTable = $("#manageSMSIndividualInfoTable").DataTable({
		'ajax': 'php_action/fetchSMSAllSH.php',
		'order': []		
	});
...
function editIndividualSMSInfo(smsid = null) {
	...
	{ 
		...
		$.ajax({
			url: 'php_action/fetchSelectedSMSAllSH.php',
			type: 'post',
			data: {smsid : smsid},
			dataType: 'json',
			success:function(response) {
			...
			success:function(response) {
				...
				$("#postingSMSIndividualBtn").unbind('click').bind('click', function() {
					...
					$.ajax({
						...
						url: 'php_action/postSMSAllSH.php',                         
						type: 'post',
						data: {smsid : smsid},
						dataType: 'json',
						success:function(response) {
						...
						$.ajax({
						url: 'php_action/send-sms-allsh.php',	
						type: 'post',
						data: {smsid : smsid},
						dataType: 'json',
						success:function(response) {
		...
		$.ajax({
			...
			success:function(response) {
				...
				$("#removeSMSIndividualBtn").unbind('click').bind('click', function() {
					...
					$.ajax({
						url: 'php_action/removeSMSAllSH.php',
						type: 'post',
						data: {smsid : smsid},
						dataType: 'json',
						success:function(response) {
